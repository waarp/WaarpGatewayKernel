...
public abstract class HttpRestHandler extends SimpleChannelUpstreamHandler {
    ...
    public static enum METHOD {
         ...
         * the client to determine the options and/or requirements associated with a resource, or
     ...
     * Note that ARG_METHOD is only set from current request. It might be also set from URI or
     * HEADER and therefore should be done in this method.
     * 
     * @param channel
