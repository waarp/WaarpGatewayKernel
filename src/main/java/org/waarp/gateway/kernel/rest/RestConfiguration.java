...
public class RestConfiguration {
    ...
    /**
     * SERVER REST interface allowing one Handler and associated CRUD (or equivalent POST, GET, PUT,
     * DELETE) methods (2^0 for active, 2^1 as Create/POST, 2^2 as Read/GET, 2^3 as Update/PUT, 2^4
     * as Delete/DELETE)
     */
